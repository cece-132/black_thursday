...
class CustomerRepository
  ...
  def initialize(file_path)
    ...
    if @file_path
        ...
        @all << Customer.new({:id => row[:id].to_i, :first_name => row[:first_name], 
        :last_name => row[:last_name], :created_at => row[:created_at], 
  ...
  def create(attributes)
    ...
    @all << Customer.new({:id => new_id, :first_name => attributes[:first_name].upcase, 
    :last_name => attributes[:last_name].upcase, :created_at => attributes[:created_at], 
